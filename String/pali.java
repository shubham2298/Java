...
public class pali {
	...
	public static void main(String[] args) {
		...
		String palFile = "/home/gslab/Desktop/java/Assignment/String/sample.txt";
...
//     pali p1=new pali();
// File infile = new File("/home/gslab/Desktop/java/Assignment/String/sample.txt");
// Scanner input = new Scanner( infile );
// while (input.hasNext()) {
// String word = input.nextLine();

// if (p1.isPalindrome(word)) {
